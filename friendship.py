...
# create make_simple_friendship take in names of 3 friends, set up a graph that make it so that each of the 3 ppl are friends
# there should be 3 nodes and 2 nodes per adjacency list

# add method that prints the name of all of the friend nodes that are present in the graph
